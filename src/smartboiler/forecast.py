...
from smartboiler.retrieve_hass import RetrieveHass
from smartboiler.machine_learning_forecaster import MLForecaster
from smartboiler.utils import get_days_list
...
class Forecast(object):
    ...
    In smartboiler we have basically 4 forecasts to deal with:
    ...
    proposed forecast treated and generated internally by this smartboiler forecast class.
    ...
    .. note:: This custom machine learning model is introduced from v0.4.0. smartboiler \
    ...
    as a runtime parameter during the `curl` to the smartboiler API.
